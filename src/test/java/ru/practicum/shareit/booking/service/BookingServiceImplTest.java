...
class BookingServiceImplTest {
    ...
    @Test
    void createBookingWithWrongDate() {
        String userId = String.valueOf(booker.getId());

        bookingPostDto.setEnd(start);
    ...
    @Test
    void createBookingWithNullStart() {
        String userId = String.valueOf(booker.getId());

        bookingPostDto.setStart(null);
    ...
    @Test
    void createBookingWithNullEnd() {
        String userId = String.valueOf(booker.getId());

        bookingPostDto.setEnd(null);
    ...
    @Test
    void createBookingWithWrongStart() {
        String userId = String.valueOf(booker.getId());

        bookingPostDto.setStart(start.minusDays(3));
    ...
    void checkWrongUserIdValidation() {
        Assertions.assertThrows(ItemHeaderException.class, () ->
                bookingService.getBooking(booking.getId(), null));
    }
    ...
    @Test
    void getAllBookingsWithWrongFromPagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookings(BookingState.CURRENT, from, size, userId));
    }

    @Test
    void getAllBookingsWithWrongFromAndSizePagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookings(BookingState.FUTURE, from, size, userId));
    }

    @Test
    void getAllBookingsWithWrongSizePagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookings(BookingState.PAST, from, size, userId));
    }
    ...
    @Test
    void getAllBookingsForAllItemsWithWrongFromPagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookingsForAllItems(BookingState.CURRENT, from, size, userId));
    }

    @Test
    void getAllBookingsForAllItemsWithWrongFromAndSizePagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookingsForAllItems(BookingState.FUTURE, from, size, userId));
    }

    @Test
    void getAllBookingsForAllItemsWithWrongSizePagination() {
        String userId = String.valueOf(booker.getId());
        ...
        Assertions.assertThrows(ValidationException.class, () ->
                bookingService.getAllBookingsForAllItems(BookingState.PAST, from, size, userId));
    }
