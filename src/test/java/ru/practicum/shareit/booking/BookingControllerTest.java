...
class BookingControllerTest {
    ...
    @Test
    void getAllBookingsUnsupportedStateTest() {
        Assertions.assertThrows(UnsupportedStatusException.class, () ->
                bookingController.getAllBookings(0, 20, "UNSUPPORTED", "1"));
    }
    ...
    @Test
    void getAllBookingsForAllItemsUnsupportedStateTest() {
        Assertions.assertThrows(UnsupportedStatusException.class, () ->
                bookingController.getAllBookingsForAllItems(0, 20, "UNSUPPORTED", "1"));
    }
}